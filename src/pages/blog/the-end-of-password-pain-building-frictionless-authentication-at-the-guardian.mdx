...
import createAccountGif from "./images/passwordless-create-account-flow.gif";
import resetPasswordGif from "./images/passwordless-reset-password-flow.gif";
import signInGif from "./images/passwordless-sign-in.gif";
import noPasswordGif from "./images/passwordless-no-password.gif";
...
<figure>
  <Image
    ...
    alt="The reset password flow demonstrating email verification using a passcode and setting a new password."
    loading="lazy"
  />
  <figcaption>
    The reset password flow demonstrating email verification using a passcode
...
<figure>
  <Image
    src={signInGif}
    alt="Demonstrating sign in flow with a passcode"
    loading="lazy"
  />
  <figcaption>
...
<figure>
  <Image
    src={noPasswordGif}
    alt="The create account flow with account verification using a passcode, with no need to set a password during the process."
    loading="lazy"
  />
  <figcaption>
    The create account flow with account verification using a passcode, with no
    need to set a password during the process.
    <i>Illustration: Mahesh Makani</i>
  </figcaption>
</figure>
